...
$(wasm32-wasi-ghc --print-libdir)/post-link.mjs -i $(wasm32-wasi-cabal list-bin client --allow-newer) -o static/wasm.js
cp $(wasm32-wasi-cabal list-bin client --allow-newer) ./static/wasm.wasm
echo Done
